...
var (
	...
	errScalarUDFInputTypeIsUNION  = fmt.Errorf("%w: input type is UNION, which is not supported", errScalarUDFCreate)
	errScalarUDFResultTypeIsUNION = fmt.Errorf("%w: result type is UNION, which is not supported", errScalarUDFCreate)
