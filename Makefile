...
deps.darwin.amd64:
	g++ -std=c++11 -fPIC -g0 -O3 --target=x86_64-apple-macos11 -DGODUCKDB_FROM_SOURCE -c duckdb.cpp
	ar rvs libduckdb.a duckdb.o
	mv libduckdb.a deps/darwin_amd64/libduckdb.a

.PHONY: deps.darwin.arm64
deps.darwin.arm64:
	g++ -std=c++11 -fPIC -g0 -O3 --target=arm64-apple-macos11 -DGODUCKDB_FROM_SOURCE -c duckdb.cpp
	ar rvs libduckdb.a duckdb.o
	mv libduckdb.a deps/darwin_arm64/libduckdb.a

.PHONY: deps.linux.amd64
deps.linux.amd64:
	g++ -std=c++11 -fPIC -g0 -O3 -DGODUCKDB_FROM_SOURCE -c duckdb.cpp
	ar rvs libduckdb.a duckdb.o
